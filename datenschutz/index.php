...
<title>Datenschutzerklärung | <?= $brandname; ?></title>
</head>
...
<body>
    ...
    <!-- Hero Section -->
    <section class="agb-hero-section">
        <div class="container">
            <div class="agb-hero-content">
                <h1>Datenschutzerklärung</h1>
                <p class="agb-subtitle">
    ...
    <!-- Content Section -->
    <section class="agb-content-section">
        <div class="container">
            <div class="row">
                <!-- Sidebar Navigation -->
                <div class="col-lg-3">
                    <div class="agb-sidebar">
                        <h4>Schnellnavigation</h4>
                        <ul class="agb-nav-list">
                            <li><a href="#datenschutz-ueberblick">Datenschutz auf einen Blick</a></li>
                            ...
                            <li><a href="#analyse-tools">Analyse-Tools und Werbung</a></li>
                            <li><a href="#plugins-tools">Plugins und Tools</a></li>
                            <li><a href="#ecommerce">eCommerce und Zahlungsanbieter</a></li>
                            <li><a href="#eigene-dienste">Eigene Dienste</a></li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="col-lg-9">
                    <div class="agb-main-content">
                        ...
                        <!-- Section 1 -->
                        <div id="datenschutz-ueberblick" class="agb-section">
                        ...
                        <!-- Section 2 -->
                        <div id="hosting" class="agb-section">
                            <h2>2. Hosting</h2>
                            ...
                            <p>Details entnehmen Sie der Datenschutzerklärung von DomainFactory: https://www.df.eu/de/datenschutz/.</p>
                        ...
                        <!-- Section 3 -->
                        <div id="allgemeine-hinweise" class="agb-section">
                            ...
                            <div class="agb-company-box">
                                <h3>Unicorn Medical Services K. Narten e.K.</h3>
                                <p><strong>Inhaber:</strong> Klaus Narten</p>
                                <div class="agb-contact-info">
                                    <div class="agb-contact-item">
                                        <i class="fa fa-map-marker-alt"></i>
                                        <span>Hambergsfeld 8<br>21394 Westergellersen (Deutschland)</span>
                                    </div>
                                    <div class="agb-contact-item">
                                        <i class="fa fa-phone"></i>
                                        <span>(04135) 82 06 69</span>
                                    </div>
                                    <div class="agb-contact-item">
                                        <i class="fa fa-envelope"></i>
                                        <span>info@unicorn-med.de</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <p style="text-transform: uppercase; font-weight: 600;">Wenn die Datenverarbeitung auf Grundlage von Art. 6 Abs. 1 lit. E oder F DSGVO erfolgt, haben Sie jederzeit das Recht, aus Gründen, die sich aus Ihrer besonderen Situation ergeben, gegen die Verarbeitung Ihrer personenbezogenen Daten Widerspruch einzulegen; dies gilt auch für ein auf diese Bestimmungen gestütztes Profiling. Die jeweilige Rechtsgrundlage, auf denen eine Verarbeitung beruht, entnehmen Sie dieser Datenschutzerklärung. Wenn Sie Widerspruch einlegen, werden wir Ihre betroffenen personenbezogenen Daten nicht mehr verarbeiten, es sei denn, wir können zwingende schutzwürdige Gründe für die Verarbeitung nachweisen, die Ihre Interessen, Rechte und Freiheiten überwiegen oder die Verarbeitung dient der Geltendmachung, Ausübung oder Verteidigung von Rechtsansprüchen (Widerspruch nach Art. 21 Abs. 1 DSGVO).</p>
                            <p style="text-transform: uppercase; font-weight: 600;">Werden Ihre personenbezogenen Daten verarbeitet, um Direktwerbung zu betreiben, so haben Sie das Recht, jederzeit Widerspruch gegen die Verarbeitung Sie betreffender personenbezogener Daten zum Zwecke derartiger Werbung einzulegen; dies gilt auch für das Profiling, soweit es mit solcher Direktwerbung in Verbindung steht. Wenn Sie widersprechen, werden Ihre personenbezogenen Daten anschließend nicht mehr zum Zwecke der Direktwerbung verwendet (Widerspruch nach Art. 21 Abs. 2 DSGVO).</p>
                        ...
                        <!-- Section 4 -->
                        <div id="datenerfassung" class="agb-section">
                            ...
                            <h3>Einsatz von Künstlicher Intelligenz (KI) zur Beantwortung von Kundenanfragen</h3>
                            ...
                            <p>Das Unternehmen verfügt über eine Zertifizierung nach dem „EU-US Data Privacy Framework" (DPF). Der DPF ist ein Übereinkommen zwischen der Europäischen Union und den USA, der die Einhaltung europäischer Datenschutzstandards bei Datenverarbeitungen in den USA gewährleisten soll. Jedes nach dem DPF zertifizierte Unternehmen verpflichtet sich, diese Datenschutzstandards einzuhalten. Weitere Informationen hierzu erhalten Sie vom Anbieter unter folgendem Link: https://www.dataprivacyframework.gov/participant/7735.</p>
                            <p>Wir nutzen WhatsApp in der Variante „WhatsApp Business".</p>
                            <p>Die Datenübertragung in die USA wird auf die Standardvertragsklauseln der EU-Kommission gestützt. Details finden Sie hier: https://www.whatsapp.com/legal/business-data-transfer-addendum.</p>
                            ...
                            <h4>Einsatz von KI-Anwendungen im Rahmen der Chatbot-Kommunikation</h4>
                            <p>Unsere Chatbots verwenden Künstliche Intelligenz (KI) im Rahmen der Kundenkommunikation. Dabei analysiert die von uns eingesetzte KI den Inhalt Ihrer Nachricht, um autonom eine passende Antwort zu generieren. In diesem Zusammenhang verarbeitet die KI sämtliche Inhalte Ihrer Nachricht, inklusive Namen, E-Mail-Adressen, Kommunikationsinhalte oder technische Informationen (z. B. IP-Adressen, Geräteinformationen).</p>
                            <p>Die Verwendung der eingesetzten KI-Software erfolgt auf Grundlage von Art. 6 Abs. 1 lit. f DSGVO. Der Websitebetreiber hat ein berechtigtes Interesse an einer möglichst effizienten Kundenkommunikation unter Einsatz moderner technischer Lösungen. Sofern eine entsprechende Einwilligung abgefragt wurde, erfolgt die Verarbeitung ausschließlich auf Grundlage von Art. 6 Abs. 1 lit. a DSGVO und § 25 Abs. 1 TDDDG. Die Einwilligung ist jederzeit widerrufbar.</p>
                            
                            <h5>Wir binden folgende KI-Anwendungen in unsere Chatbots ein:</h5>
                            
                            <h6>ChatGPT</h6>
                            <p>Unsere Chatbots nutzen ChatGPT für unsere Kundenkommunikation. Anbieter ist die OpenAI, 3180 18th St, San Francisco, CA 94110, USA, https://openai.com. Wenn Sie also Kontakt via Chatbot zu uns aufnehmen, können Ihre Anfragen inklusive Metadaten an die Server von ChatGPT übertragen und dort verarbeitet werden, um eine passende Antwort zu generieren.</p>
                            <p>Weitere Informationen erhalten Sie hier: https://openai.com/policies/privacy-policy.</p>
                            ...
                            <p>Die Datenübertragung in die USA wird auf die Standardvertragsklauseln der EU-Kommission gestützt. Details finden Sie hier: https://workspace.google.com/terms/dpa_terms.html und hier https://cloud.google.com/terms/sccs.</p>
                            <p>Das Unternehmen verfügt über eine Zertifizierung nach dem „EU-US Data Privacy Framework" (DPF). Der DPF ist ein Übereinkommen zwischen der Europäischen Union und den USA, der die Einhaltung europäischer Datenschutzstandards bei Datenverarbeitungen in den USA gewährleisten soll. Jedes nach dem DPF zertifizierte Unternehmen verpflichtet sich, diese Datenschutzstandards einzuhalten. Weitere Informationen hierzu erhalten Sie vom Anbieter unter folgendem Link: https://www.dataprivacyframework.gov/participant/5780.</p>
                        </div>

                        <!-- Section 5 -->
                        <div id="analyse-tools" class="agb-section">
                            ...
                            <p>Die Datenübertragung in die USA wird auf die Standardvertragsklauseln der EU-Kommission gestützt. Details finden Sie hier: https://business.safety.google/adscontrollerterms/sccs/.</p>
                            <p>Das Unternehmen verfügt über eine Zertifizierung nach dem „EU-US Data Privacy Framework" (DPF). Der DPF ist ein Übereinkommen zwischen der Europäischen Union und den USA, der die Einhaltung europäischer Datenschutzstandards bei Datenverarbeitungen in den USA gewährleisten soll. Jedes nach dem DPF zertifizierte Unternehmen verpflichtet sich, diese Datenschutzstandards einzuhalten. Weitere Informationen hierzu erhalten Sie vom Anbieter unter folgendem Link: https://www.dataprivacyframework.gov/participant/5780.</p>
                        ...
                        <!-- Section 6 -->
                        <div id="plugins-tools" class="agb-section">
                            ...
                            <p>Weitere Informationen zu Font Awesome finden Sie und in der Datenschutzerklärung von Font Awesome unter: https://fontawesome.com/privacy.</p>
                            ...
                            <h3>CleanTalk</h3>
                            <p>Diese Website nutzt Anti-Spam Plugins von CleanTalk. Anbieter ist die CleanTalk Inc, 711 S Carson Street, suite 4, Carson City, NV, 89701, USA (nachfolgend „CleanTalk").</p>
                            <p>CleanTalk dient dem Schutz unserer Website von Spam-Aktivitäten (z. B. Verhindern von unerwünschter Werbung, unerwünschten Nachrichten oder Kommentaren). Zu diesem Zweck erfasst CleanTalk verschiedene personenbezogene Daten wie IP-Adresse, E-Mail-Adresse, Nickname des Nachrichtensenders, Informationen über die Technologie von JavaScript im Browser des Senders und die eingegebenen Texte.</p>
                            <p>Diese Informationen werden an einen Server von CleanTalk in den EU übertragen und dort gespeichert.</p>
                            <p>Aus Sicherheitsgründen und als Schutz vor Spam werden Ihre Daten im CleanTalk Cloud Service verarbeitet und in Logfiles für maximal 31 Tage gespeichert. Nach Ablauf der genannten Frist werden diese Daten vollständig gelöscht.</p>
                            <p>Die Verwendung von CleanTalk erfolgt auf Grundlage von Art. 6 Abs. 1 lit. f DSGVO. Der Websitebetreiber hat ein berechtigtes Interesse an einem möglichst effektiven Schutz seiner Website Spam-Aktivitäten. Sofern eine entsprechende Einwilligung abgefragt wurde, erfolgt die Verarbeitung ausschließlich auf Grundlage von Art. 6 Abs. 1 lit. a DSGVO und § 25 Abs. 1 TDDDG, soweit die Einwilligung die Speicherung von Cookies oder den Zugriff auf Informationen im Endgerät des Nutzers im Sinne des TDDDG umfasst. Die Einwilligung ist jederzeit widerrufbar.</p>
                            <p>Die Datenübertragung in die USA wird auf die Standardvertragsklauseln der EU-Kommission gestützt. Details finden Sie hier:https://cleantalk.org/publicoffer#privacy.</p>
                        ...
                        <!-- Section 7 -->
                        <div id="ecommerce" class="agb-section">
                        ...
                        <!-- Section 8 -->
                        <div id="eigene-dienste" class="agb-section">
                        ...
                        <!-- Contact Box -->
                        <div class="agb-contact-box">
                            <h3>Haben Sie Fragen zum Datenschutz?</h3>
                            <p>Wenn Sie Fragen zu dieser Datenschutzerklärung oder zur Verarbeitung Ihrer personenbezogenen Daten haben, kontaktieren Sie uns gerne:</p>
                            <div class="agb-contact-info">
                                <div class="agb-contact-item">
                                    <i class="fa fa-envelope"></i>
                                    <span>info@unicorn-med.de</span>
